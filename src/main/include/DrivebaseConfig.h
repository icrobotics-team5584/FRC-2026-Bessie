...
namespace DrivebaseConfig {
  // Drive controls
  constexpr units::meters_per_second_t MAX_VELOCITY = 4.6_mps;
  constexpr units::turns_per_second_t MAX_TELEOP_ANGULAR_VELOCITY = 300_deg_per_s;
  ...
  const units::turn_t FRONT_RIGHT_MAG_OFFSET = BotVars::Choose(-0.195068359375_tr, -0.446044921875_tr); //-0.94384765625_tr - 0.25_tr
  const units::turn_t FRONT_LEFT_MAG_OFFSET = BotVars::Choose(-0.131591796875_tr, -0.26611328125_tr); //-0.37451171875_tr + 0.25_tr
  const units::turn_t BACK_RIGHT_MAG_OFFSET = BotVars::Choose(-0.106689453125_tr, -0.675048828125_tr); //-0.353515625_tr + 0.25_tr
  const units::turn_t BACK_LEFT_MAG_OFFSET = BotVars::Choose(-0.543701171875_tr, -0.824951171875_tr); //-0.464111328125_tr - 0.25_tr
