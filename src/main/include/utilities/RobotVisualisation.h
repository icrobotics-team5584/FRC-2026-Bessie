...
class RobotVisualisation {
 public:
  ...
  frc::Mechanism2d _display{0.50, 0.50};

  // Turret Visualisation
  frc::MechanismRoot2d* _turretMechRoot = _display.GetRoot("turretRoot", 0.025, 0.125);
  MechanismCircle2d _turretMechCircle{_turretMechRoot, "turretCircle", 0.05, 0_deg};

  // Deploy/Intake Visualisation
  frc::MechanismRoot2d* _deployRoot = _display.GetRoot("Deploy Root", 0.125, 0.125);
  ...
  // Hood Visualisation
  frc::MechanismRoot2d* _hoodMechRoot = _display.GetRoot("hoodRoot", 0.325, 0.125);
  MechanismCircle2d _hoodMechCircle{_hoodMechRoot, "hoodCircle", 0.05, 0_deg};

  // Shooter Visualisation
  frc::MechanismRoot2d* _shooterMechRoot = _display.GetRoot("shooterRoot", 0.440, 0.125);
  ...
  frc::MechanismRoot2d* _indexerMechRoot = _display.GetRoot("indexerRoot", 0.060, 0.350);
  MechanismCircle2d _indexerMechCircle{_indexerMechRoot, "indexerCircle", 0.10, 0_deg};

  // Outdexer Visualisation
  frc::MechanismRoot2d* _outdexerMechRoot = _display.GetRoot("outdexerRoot", 0.230, 0.350);
