...
class Robot : public frc::TimedRobot {
 ...
 private:
  ...
  frc::Pose3d turretPose = frc::Pose3d{0.5_m,-0.2_m,1.13_m, frc::Rotation3d{0_deg, 0_deg, 0_deg}};
  frc::Pose3d hoodPose = frc::Pose3d{0.5_m,-0.2_m,1.13_m, frc::Rotation3d{0_deg, 0_deg, 0_deg}};
